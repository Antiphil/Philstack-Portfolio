...
<Offpagenavbar />
<div class="m-auto mt-16 max-w-7xl p-3 md:p-10">
	<div class="flex flex-col-reverse items-center justify-between gap-2 md:flex-row">
		<div class=" flex w-full items-center justify-between rounded-xl bg-secondary-900 px-5 py-3 text-xs">
			<div class="">
				<nav>
					<ul class="flex items-center gap-3 text-xs font-semibold">
						<li><a href="/{$locale}/"><i class="fa-solid fa-house mr-1"></i> <span>Home</span></a></li>
	...
	<div class="mb-5 mt-10 flex justify-center">
		<div class="flex items-center gap-4">
			<button on:click={prevPage} disabled={curPage === 1} class="flex select-none items-center gap-2 rounded-full px-6 py-3 text-center align-middle text-xs font-bold uppercase text-primary-main transition-all hover:bg-primary-main/10 active:bg-primary-main/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
			...
			<div class="flex items-center gap-2 font-bold">
				{#if pagination.pageCount > 1 && pagination.page > 1}
					<button class="relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-full text-center align-middle text-xs uppercase text-primary-main transition-all hover:bg-primary-main/10 active:bg-primary-main/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
						<span class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform"> {pagination.page - 1} </span>
					</button>
				{/if}

				<button class="relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-full bg-primary-main text-center align-middle text-xs uppercase text-secondary-800 shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
			...
			<button on:click={nextPage} disabled={curPage === pagination.pageCount} class="flex select-none items-center gap-2 rounded-full px-6 py-3 text-center align-middle text-xs font-bold uppercase text-primary-main transition-all hover:bg-primary-main/10 active:bg-primary-main/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button">
				Next
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" class="h-4 w-4">
