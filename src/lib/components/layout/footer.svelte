...
<footer class="p-4 sm:p-6">
	<div class="px-20">
			...
			<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
				<div>
					...
					<ul class="text-gray-600 dark:text-gray-400">
						<li class="mb-4">
							<a href="https://flowbite.com" class="hover:underline">Impressum</a>
						</li>
						<li>
							<a href="https://tailwindcss.com/" class="hover:underline">Datenschutz</a>
						</li>
					</ul>
				</div>
				<div>
				...
				<div>
					...
					<ul class="text-gray-600 dark:text-gray-400">
						...
						<li>
							<a href="#" class="hover:underline">Ipsum</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="sm:flex sm:items-center sm:justify-between">
			<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://philstack.de" class="hover:underline">Philstack.de</a>. All Rights Reserved. </span>
