...
<div class="relative flex w-full flex-col rounded-3xl border-2 border-[#EDE9D0] shadow-[4px_4px_0px_rgba(237,233,208,1)] sm:h-[200px]">
	...
	<div class="flex w-full flex-col items-center justify-center sm:relative sm:right-10 sm:w-[90%]">
		<div class="left-[-100px] top-[-10%] z-40 w-full bg-[#EDE9D0] p-3 text-secondary sm:absolute sm:w-[400px] sm:rounded-3xl sm:p-5">
			<h3 class="mb-1 text-xs uppercase">Post about: <span class="rounded-lg bg-secondary px-2 py-1 text-sm font-semibold text-primary"> {tag}</span></h3>
