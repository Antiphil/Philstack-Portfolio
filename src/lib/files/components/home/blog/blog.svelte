...
<section class="relative flex w-full pr-[70px] py-[35px]">
    <div class="right-0 top-[calc(0px-35px)] !absolute !z-50 curved-corner-topright"></div>
    <div class="left-0 top-[calc(0px-65px)] !absolute !z-50 curved-corner-bottomleft"></div>
    <div class="relative bg-secondary w-full h-full rounded-r-[75px] overflow-hidden p-10 flex gap-3">
        <section class="px-5 py-10 ">
            <div class="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
                ...
                <div class="relative flex col-span-12 bg-center bg-no-repeat bg-cover dark:bg-gray-500 xl:col-span-6 lg:col-span-5 md:col-span-9 min-h-96" style="background-image: url('https://source.unsplash.com/random/239x319');">
                    <span class="absolute px-1 pb-2 text-xs font-bold uppercase border-b-2 left-6 top-6 border-[#fdff98] dark:text-gray-100">paris, france</span>
                    <a class="flex flex-col items-center justify-end p-6 text-center sm:p-8 group dark:via-transparent flex-grow-1 bg-gradient-to-b dark:from-gray-900 dark:to-gray-900">
                        <span class="flex items-center mb-4 space-x-2 dark:text-[#fdff98]">
                            <span class="relative flex-shrink-0 w-2 h-2 rounded-full dark:bg-[#fdff98]">
                                <span class="absolute flex-shrink-0 w-3 h-3 rounded-full -left-1 -top-1 animate-ping dark:bg-[#fdff98]"></span>
                            </span>
                ...
                <div class="hidden py-2 xl:col-span-3 lg:col-span-4 md:hidden lg:block">
                    <div class="mb-8 space-x-5 border-b-2 border-opacity-10 border-[#fdff98]">
                        <button type="button" class="pb-5 text-xs font-bold uppercase border-b-2 border-[#fdff98]">Latest</button>
                        <button type="button" class="pb-5 text-xs font-bold uppercase border-b-2 dark:border-transparent ">Popular</button>
                    </div>
                        ...
                        <div class="flex px-1 py-4">
                            ...
                            <div class="flex flex-col flex-grow">
                                ...
                                <p class="mt-auto text-xs ">5 minutes ago
                                    <a rel="noopener noreferrer" href="#" class="block dark:text-[#fdff98] lg:ml-2 lg:inline hover:underline">Politics</a>
                                </p>
                            </div>
                        </div>
                        <div class="flex px-1 py-4">
                            ...
                            <div class="flex flex-col flex-grow">
                                ...
                                <p class="mt-auto text-xs ">14 minutes ago
                                    <a rel="noopener noreferrer" href="#" class="block dark:text-[#fdff98] lg:ml-2 lg:inline hover:underline">Sports</a>
                                </p>
                            </div>
                        </div>
                        <div class="flex px-1 py-4">
                            ...
                            <div class="flex flex-col flex-grow">
                                ...
                                <p class="mt-auto text-xs ">22 minutes ago
                                    <a rel="noopener noreferrer" href="#" class="block dark:text-[#fdff98] lg:ml-2 lg:inline hover:underline">World</a>
                                </p>
                            </div>
                        </div>
                        <div class="flex px-1 py-4">
                            ...
                            <div class="flex flex-col flex-grow">
                                ...
                                <p class="mt-auto text-xs ">37 minutes ago
                                    <a rel="noopener noreferrer" href="#" class="block dark:text-[#fdff98] lg:ml-2 lg:inline hover:underline">Business</a>
                                </p>
                            </div>
                        </div>
                    </div>
